...
exec "hi DiffAdd ctermfg=".hi." ctermbg=".light_gray
exec "hi DiffChange ctermfg=".gray_400." ctermbg=".light_gray
exec "hi DiffDelete ctermfg=".hi." ctermbg=".light_gray
exec "hi DiffText ctermfg=".gray_400." ctermbg=".gray_800
exec "hi ErrorMsg ctermfg=".gray_400." ctermbg=".hi
...
exec "hi WarningMsg ctermfg=".hi

unlet gray_900 light_gray gray_800 gray_700 gray_500 gray_400 hi
